...
Route::group(['namespace' => 'front', 'middleware' => 'MaintenanceMiddleware'], function () {
	...
	Route::get('/add-order-type/{type}', [HomeController::class, 'saveOrderType'])->name('save_order_type');
...
//	Route::get('/menu', [MenuController::class, 'index'])->name('menu');
	...
	Route::get('/search-products/{search?}', [MenuController::class, 'searchProducts'])->name('searchproducts');
	Route::get('/category-products/{categoryId}', [MenuController::class, 'categoryProducts'])->name('categoryproducts');
