<table class="table table-striped table-bordered zero-configuration">
    <thead>
        <tr>
            ...
            <th>{{ trans('labels.status_update') }}</th>
            ...
            <tr id="dataid{{ $orderdata->id }}">
                ...
                <td>
                    <div class="d-flex flex-wrap gap-1">
                        <a class="btn btn-sm btn-secondary square" target="_blank" tooltip="View" title="{{ trans('labels.view') }}"
                            href="{{ URL::to('admin/invoice/' . $orderdata->id) }}"><i
                                class="fa-regular fa-eye"></i></a>
                        <a class="btn btn-sm btn-primary square" target="_blank" tooltip="Print" title="{{ trans('labels.print') }}"
                        ...
                        @if (
                            ...
                            <a class="btn btn-sm btn-info square" tooltip="Payment Status"
                                onclick="codpayment('{{ $orderdata->order_number }}','{{ $orderdata->grand_total }}','{{ $orderdata->transaction_type }}','{{ helper::image_path($orderdata->screenshot) }}')">
