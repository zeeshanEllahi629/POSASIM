...
<ul class="navbar-nav">
    ...
    <!-- <li class="nav-item mb-2 fs-7 {{ @Auth::user()->type != 1 ? (in_array('23', $modules) == true ? '' : 'd-none') : '' }}"
        ...
        <a class="nav-link rounded d-flex {{ request()->is('admin/systemaddons*') ? 'active' : '' }}"
            ...
            <i class="fa fa-puzzle-piece"></i><span
                class="nav-text d-flex justify-content-between w-100">{{ trans('labels.addons_manager') }}</span>
    ...
    <li class="nav-item mb-2 fs-7 {{ @Auth::user()->type != 1 ? (in_array('30', $modules) == true ? '' : 'd-none') : '' }}"
        ...
        <a class="nav-link rounded d-flex {{ request()->is('admin/tax*') ? 'active' : '' }}"
            ...
            <i class="fa-solid fa-magnifying-glass-dollar"></i><span
                class="nav-text ">{{ trans('labels.tax') }}</span>
        </a>
    </li>
    <li class="nav-item mb-2 fs-7 {{ @Auth::user()->type != 1 ? (in_array('31', $modules) == true ? '' : 'd-none') : '' }}"
        ...
        <a class="nav-link rounded d-flex {{ request()->is('admin/global_extras*') ? 'active' : '' }}"
            ...
            <i class="fa-solid fa-globe"></i><span class="nav-text ">{{ trans('labels.global_extras') }}</span>
        </a>
    </li>
    ...
    <li class="nav-item mb-2 fs-7 {{ @Auth::user()->type != 1 ? (in_array('10', $modules) == true ? '' : 'd-none') : '' }}"
        id="10">
        <a class="nav-link rounded d-flex {{ request()->is('admin/item*') && !request()->is('admin/item/import*') ? 'active' : '' }}"
    ...
    @if (@helper::checkaddons('product_import'))
        <li class="nav-item mb-2 fs-7 {{ @Auth::user()->type != 1 ? (in_array('34', $modules) == true ? '' : 'd-none') : '' }}"
            id="34">
            <a class="nav-link rounded d-flex {{ request()->is('admin/item/import*') ? 'active' : '' }}"
                href="{{ URL::to('/admin/item/import') }}" aria-expanded="false">
                <i class="fa-solid fa-cloud-arrow-up"></i>
                <div class="w-100 d-flex justify-content-between align-items-center">
                    {{ trans('labels.bluckimportproduct') }}
                    @if (env('Environment') == 'sendbox')
                        <small class="badge bg-danger">{{ trans('labels.addon') }}</small>
                    @endif
                </div>
    ...
    @endif
    <li class="nav-item mb-2 fs-7 {{ @Auth::user()->type != 1 ? (in_array('35', $modules) == true ? '' : 'd-none') : '' }}"
        id="10">
        <a class="nav-link rounded d-flex {{ request()->is('admin/shipping*') ? 'active' : '' }}"
            href="{{ URL::to('/admin/shipping') }}" aria-expanded="false">
            <i class="fa-solid fa-truck-fast"></i><span
                class="nav-text ">{{ trans('labels.shipping_management') }}</span>
        </a>
    </li>
    @if (@Auth::user()->type != 1)
...
{{--            <i class="fa-solid fa-circle-info"></i><span class="nav-text ">{{ trans('labels.inquiries') }}</span>--}}
{{--        </a>--}}
{{--    </li>--}}
    @if (@helper::checkaddons('product_inquiry'))
        <li class="nav-item mb-2 fs-7 {{ @Auth::user()->type != 1 ? (in_array('36', $modules) == true ? '' : 'd-none') : '' }}"
            id="16">
            <a class="nav-link rounded d-flex {{ request()->is('admin/product_inquiry*') ? 'active' : '' }}"
                href="{{ URL::to('/admin/product_inquiry') }}" aria-expanded="false">
    ...
    @endif
    @if (@Auth::user()->type != 1)
        @if (in_array('21', $modules) || in_array('32', $modules))
            <li class="nav-item mt-3">
    ...
    @if (@helper::checkaddons('telegram_message'))
        <li class="nav-item mb-2 fs-7 {{ @Auth::user()->type != 1 ? (in_array('37', $modules) == true ? '' : 'd-none') : '' }}"
            id="28">
            <a class="nav-link rounded d-flex {{ request()->is('admin/telegram_settings*') ? 'active' : '' }}"
                href="{{ URL::to('/admin/telegram_settings') }}" aria-expanded="false">
...
{{--        <li class="nav-item mb-2 fs-7 {{ @Auth::user()->type != 1 ? (in_array('27', $modules) == true ? '' : 'd-none') : '' }}"--}}
{{--            id="27">--}}
