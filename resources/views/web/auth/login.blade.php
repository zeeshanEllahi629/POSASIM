...
<head>
    ...
    <style>
        ...
        .bg-image {
            background-image: url({{ url('storage/app/public/web-assets/images/login-bg.jpg')}});
    ...
    <div class="row h-100">
        <div class="col-md-5 col-lg-4 d-flex flex-column justify-content-center bg-dark text-white p-5">
            ...
            <div class="text-center">
                Don't have an account? <a href="{{url('/register')}}" class="text-danger text-decoration-none">Sign Up</a>
            </div>
        </div>
