                        ...
                        @if (@helper::checkaddons('product_inquiry'))
                            <li class="nav-item" role="presentation">
                                <a class="nav-link " href="javascript:void(0)" data-bs-toggle="pill"
                                    ...
                                    tabindex="-1">{{ trans('labels.product_inquiry') }}
                                </a>
                            </li>
                        @endif
                    </ul>
                            ...
                            <div class="card sevirce-trued">
                                <div class="card-body">
                                    <form action="{{ URL::to('product_inquiry') }}" method="POST">
                                        @csrf
                                        <input type="hidden" name="product_id" value="{{ $getitemdata->id }}">
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <p class="fs-8 mb-1">{{ trans('labels.note') }}
                                                    {{ trans('messages.product_inquiry_note') }}</p>
                                                <textarea class="form-control m-0" id="message" placeholder="{{ trans('labels.textarea') }}" name="message"
